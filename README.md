...
[![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Fira+Code&pause=1000&width=600&lines=DevOps+Engineer+;Cloud+Automation;Kubernetes+%7C+Terraform+%7C+Docker+%7C+CI%2FCD)](https://git.io/typing-svg)

---

## 🚀 About Me

🔭 Designing and deploying highly available AWS infrastructure using Terraform and Kubernetes (EKS)  
⚙️ Automating CI/CD pipelines using Jenkins, Docker & GitHub Actions  
📦 Managing containerized applications with Docker & Kubernetes  
📊 Implementing monitoring & observability using Prometheus & Grafana  
⚡ Focused on automation, reliability engineering & cost optimization  
...
<p align="left">
  ...
  <a href="https://github.com/devendesingh1999" target="_blank">
...
- 🔹 End-to-End CI/CD Pipeline (Docker → Jenkins → Kubernetes)  
